...
// TARGET DOCUMENT PATH - the migrated document should land at this path
const TARGET_PATH = '/angulohe-wknd-trendesetters-2026-06-02';
...
export default {
  transform: (payload) => {
    ...
    // 6. Use the explicit target document path for this migration
